<header class="app-header">
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="d-block d-lg-none">
            <img src="{{ asset('dist/images/logo.svg') }}" width="180" alt="" />
        </div>
              ...
              <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                ...
                <div class="py-6 px-7 mb-1">
                  <button class="btn btn-outline-primary w-100"> See All Notifications </button>
                    ...
                    @if (app()->getLocale() === 'ar')
                        <li class="nav-item mx-2"><a class="" rel="alternate" hreflang="en"
                                href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">
                                {{ LaravelLocalization::getSupportedLocales()['en']['native'] }}</a>
                        </li>
                    @else
                        <li class="nav-item"><a class="" rel="alternate" hreflang="ar"
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="profile-dropdown position-relative" data-simplebar>
                                    ...
                                    <div class="message-body">
                                        <a href="{{ route('dash.profile') }}" class="py-8 px-7 mt-8 d-flex align-items-center">
                                            <span
                                            ...
                                            <div class="w-75 d-inline-block v-middle ps-3">
                                                <h6 class="mb-1 bg-hover-primary fw-semibold">{{ Auth::user()->name }}</h6>
                                                <span class="d-block text-dark">{{ Auth::user()->email }}</span>
                                            </div>
                                        </a>
